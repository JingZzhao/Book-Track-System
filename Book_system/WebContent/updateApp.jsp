		...
		<div class="container">			
			...
			<section class="main clearfix">
				...
				<div class="fleft">
					...
					Rating:<input id="text3" type="number"  name="Rating" maxLength="10" style="width:150px; height:20px" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;"><br>
